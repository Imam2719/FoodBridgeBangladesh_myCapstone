...
import {
  ...
  Zap, Crown, Package,originalText
} from 'lucide-react';
...
const HomePage = () => {
  ...
  const stats = [
    ...
    { 
      ...
      number: '500+', 
      label: 'Active Donors', 
      description: 'Committed partners fighting hunger',
    ...
    { 
      ...
      number: '200+', 
      label: 'Food Sellers', 
      description: 'Vendors offering affordable food options',
    ...
    { 
      ...
      number: '50+', 
      label: 'Communities', 
      description: 'Areas served across Bangladesh',
...
const handleContactSubmit = async (e) => {
  ...
  try {
    ...
    if (attachedFiles.length > 0) {
      // For simplicity, we'll only send the first file
      // You can modify this to handle multiple files if needed
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="group bg-gradient-to-r from-emerald-600 to-emerald-700 dark:from-emerald-500 dark:to-emerald-600 text-white px-6 py-3 rounded-lg font-medium hover:from-emerald-700 hover:to-emerald-800 dark:hover:from-emerald-600 dark:hover:to-emerald-700 transition-all flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                 Donate Food
              ...
              <button
                onClick={() => navigate('/login')}
                className="group bg-gradient-to-r from-emerald-100 to-blue-100 dark:from-emerald-900/40 dark:to-blue-900/40 text-emerald-700 dark:text-emerald-300 px-6 py-3 rounded-lg font-medium hover:from-emerald-200 hover:to-blue-200 dark:hover:from-emerald-800/60 dark:hover:to-blue-800/60 transition-all flex items-center justify-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5 border border-emerald-200 dark:border-emerald-700"
              >
                Request Food
                <ArrowRight className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" />
              </button>
          ...
          <div className="lg:w-1/2">
            <div className="relative">
              ...
              {/* Enhanced stats grid with dark mode */}
              <div className="relative grid grid-cols-2 gap-4">
                {stats.map((stat, index) => (
                  <div
                    key={stat.label}
                    className={`bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-xl transition-all border border-gray-100 dark:border-gray-700 hover:border-emerald-200 dark:hover:border-emerald-600 transform hover:-translate-y-1 ${
                      activeIndex === index ? 'ring-2 ring-emerald-500/50 dark:ring-emerald-400/50 scale-105' : ''
                    }`}
                  >
