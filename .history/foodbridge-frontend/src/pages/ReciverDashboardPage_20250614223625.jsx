...
const renderReportModal = () => {
  ...
  const reportCategories = [
    ...
    { value: 'FRAUD', label: 'Fraudulent Listing', icon: ExclamationTriangle, color: 'red' },
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <div className={`mt-1 text-xs ${
                reportFormData.reportReason.length < 10 
                  ? 'text-red-500' 
        ...
        {/* Modal Footer */}
        <div className={`sticky bottom-0 w-full p-4 border-t z-10 flex justify-end ${
