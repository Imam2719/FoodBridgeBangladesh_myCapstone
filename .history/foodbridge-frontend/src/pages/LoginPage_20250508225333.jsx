...
// Food items for animated background
const foodIcons = [
  { icon: '🍎', delay: 0 },
  { icon: '🍕', delay: 1 },
  { icon: '🥗', delay: 2 },
...
const LoginPreview = () => {
  ...
  // Generate floating food items for the background
  useEffect(() => {
    const items = [];
    for (let i = 0; i < 20; i++) {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      ...
      <button 
        ...
        className="absolute top-4 right-4 z-50 bg-white dark:bg-gray-800 p-2 rounded-full shadow-md"
      >
