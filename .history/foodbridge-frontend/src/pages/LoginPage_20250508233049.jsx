...
const LoginPage = () => {
  ...
  const generateRandomPosition = () => {
    return {
      ...
      size: Math.floor(Math.random() * 30) + 20, // Size between 20-50px
      duration: Math.floor(Math.random() * 15) + 15, // Animation duration 15-30s
  ...
  useEffect(() => {
    ...
    // Regenerate some icons every 10 seconds to keep the background dynamic
    const interval = setInterval(() => {
      setBackgroundIcons(prevIcons => {
        // Replace 5 random icons with new ones
