...
const fetchPaymentHistory = async () => {
  try {
    ...
    if (response.ok) {
      ...
      setFeeData(prev => ({ ...prev, paymentHistory: history }));
    }
  } catch (error) {
  ...
  return (
    <div className="merchant-dashboard dark:bg-gray-900 dark:text-gray-100">
      ...
      <main className="dashboard-main" style={{ paddingTop: '64px' }}>
        ...
        // Replace the existing content-header and stats-summary sections in MerchantDashboardPage.jsx with this redesigned version

{/* ========== REDESIGNED PREMIUM HEADER WITH WELCOME MESSAGE ========== */}
<div className="redesigned-premium-header">
  <div className="welcome-section">
    <div className="welcome-content">
      <div className="welcome-greeting">
        <h1 className="welcome-title">
          Welcome back, <span className="username-highlight">{userProfile.name || 'Merchant'}</span>
        </h1>
  ...
  {/* ========== REDESIGNED PREMIUM ACTION BUTTONS LAYOUT ========== */}
  <div className="premium-actions-layout">
    
    {/* Main Action Buttons Grid */}
    <div className="main-actions-grid">
      <button className="premium-main-btn fees-btn" onClick={handleFees}>
        <div className="btn-icon-wrapper">
          <div className="btn-icon-bg"></div>
          <Wallet size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-main-label">Pay Fees</span>
          <span className="btn-sub-label">Manage payments</span>
        </div>
        <div className="btn-hover-arrow">
          <ArrowRight size={18} />
        </div>
      </button>

      <button className="premium-main-btn donations-btn" onClick={() => setDonationsOpen(true)}>
        <div className="btn-icon-wrapper">
          <div className="btn-icon-bg"></div>
          <Heart size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-main-label">My Donations</span>
          <span className="btn-sub-label">Track donations</span>
        </div>
        <div className="btn-hover-arrow">
          <ArrowRight size={18} />
        </div>
      ...
      <button className="premium-main-btn sales-btn" onClick={handleSalesHistory}>
        <div className="btn-icon-wrapper">
          <div className="btn-icon-bg"></div>
          <History size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-main-label">Sales History</span>
          <span className="btn-sub-label">View reports</span>
        </div>
        <div className="btn-hover-arrow">
          <ArrowRight size={18} />
        </div>
      ...
      <button className="premium-main-btn messages-btn" onClick={handleMessages}>
        <div className="btn-icon-wrapper">
          <div className="btn-icon-bg"></div>
          <MessageSquare size={24} />
          {messageStats.unreadMessages > 0 && (
            <div className="redesigned-notification-badge">
              {messageStats.unreadMessages > 99 ? '99+' : messageStats.unreadMessages}
            </div>
          )}
        </div>
        <div className="btn-text-content">
          <span className="btn-main-label">Messages</span>
          <span className="btn-sub-label">Communications</span>
        </div>
        <div className="btn-hover-arrow">
          <ArrowRight size={18} />
        </div>
      ...
      <button className="premium-main-btn profile-btn" onClick={handleProfileUpdate}>
        <div className="btn-icon-wrapper">
          <div className="btn-icon-bg"></div>
          <Settings size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-main-label">Profile</span>
          <span className="btn-sub-label">Account settings</span>
        </div>
        <div className="btn-hover-arrow">
          <ArrowRight size={18} />
        </div>
    ...
    <div className="special-actions-row">
      <button className="premium-create-btn" onClick={() => handleOpenModal()}>
        <div className="create-btn-bg"></div>
        <div className="create-btn-content">
          <div className="create-icon-container">
            <Plus size={28} />
            <div className="create-icon-glow"></div>
          </div>
          <div className="create-text-content">
            <span className="create-main-text">Create Listing</span>
            <span className="create-sub-text">Add new item</span>
          </div>
        </div>
        <div className="create-sparkle-1">✨</div>
        <div className="create-sparkle-2">⭐</div>
      </button>
      ...
      <button className="premium-logout-btn" onClick={handleLogout}>
        ...
        <div className="logout-text-content">
          <span className="logout-main-text">Logout</span>
          <span className="logout-sub-text">Sign out</span>
        </div>
      </button>
    </div>
  </div>
...
{/* ========== ENHANCED PREMIUM STATISTICS OVERVIEW SECTION ========== */}
<div className={`enhanced-premium-stats-container ${statsVisible ? 'expanded' : 'collapsed'}`}>
  <div className="enhanced-stats-header">
    <div className="stats-title-section">
      <div className="stats-icon-title">
        <div className="stats-icon-bg">
          <Activity size={28} />
        </div>
        <div className="stats-title-content">
          <h3 className="stats-main-title">Business Overview</h3>
          <p className="stats-subtitle">Real-time insights into your business performance</p>
        </div>
      </div>
    </div>
    <button className="enhanced-toggle-btn" onClick={toggleStats}>
      <span className="toggle-text">{statsVisible ? 'Collapse' : 'Expand'}</span>
      <div className="toggle-icon-container">
        {statsVisible ? <ChevronDown size={20} /> : <ArrowRight size={20} />}
      </div>
    </button>
  </div>
  ...
  {statsVisible && (
    <div className="enhanced-stats-grid">
      {/* Items Sold Card */}
      <div className="enhanced-stat-card items-sold-card">
        ...
        <div className="stat-card-content">
          {overviewStats.loading ? (
            ...
            <>
              <h4 className="stat-number">{getTotalItemsSold().toLocaleString()}</h4>
              <p className="stat-label">Total Items Sold</p>
              <div className="stat-sublabel">Lifetime sales performance</div>
            </>
          )}
        </div>
      ...
      <div className="enhanced-stat-card active-listings-card">
        <div className="stat-card-decoration"></div>
        <div className="stat-card-header">
          <div className="stat-icon-container">
            <div className="stat-icon-bg">
        ...
        <div className="stat-card-content">
          {overviewStats.loading ? (
            ...
            <>
              <h4 className="stat-number">{getActiveListings()}</h4>
              <p className="stat-label">Active Listings</p>
              <div className="stat-sublabel">Currently available items</div>
            </>
          )}
        </div>
        <div className="stat-card-footer">
      ...
      {/* Total Revenue Card */}
      <div className="enhanced-stat-card revenue-card">
        <div className="stat-card-decoration"></div>
        <div className="stat-card-header">
          <div className="stat-icon-container">
            <div className="stat-icon-bg">
        ...
        <div className="stat-card-content">
          {overviewStats.loading ? (
            ...
            <>
              <h4 className="stat-number">৳{getTotalRevenue()}</h4>
              <p className="stat-label">Total Revenue</p>
              <div className="stat-sublabel">All-time earnings</div>
            </>
          )}
        </div>
        <div className="stat-card-footer">
  ...
  {!statsVisible && (
    <div className="enhanced-collapsed-preview">
      <div className="preview-stat">
        <div className="preview-icon">
          <Package size={20} />
        </div>
        <div className="preview-content">
          <span className="preview-number">{overviewStats.loading ? '...' : getTotalItemsSold()}</span>
          <span className="preview-label">Items Sold</span>
        </div>
      </div>
      ...
      <div className="preview-stat">
        ...
        <div className="preview-content">
          <span className="preview-number">{overviewStats.loading ? '...' : getActiveListings()}</span>
      ...
      <div className="preview-stat">
        ...
        <div className="preview-content">
          <span className="preview-number">{overviewStats.loading ? '...' : `৳${getTotalRevenue()}`}</span>
