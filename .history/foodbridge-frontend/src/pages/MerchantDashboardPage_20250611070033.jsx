...
const NewMessageModal = () => {
  ...
  const [toEmail, setToEmail] = useState('sfms0674@gmail.com');
  ...
  const handleRecipientTypeChange = (type) => {
    ...
    setToEmail(type === 'admin' ? 'sfms0674@gmail.com' : '');
    setSubject('');
    setMessage('');
    setAttachment(null);
  };
            ...
            <div className="message-form">
              ...
              <div className="form-section">
                ...
                <div className="email-input-container">
                  <input
                    ...
                    placeholder={recipientType === 'admin' ? "Admin Email (Auto-filled)" : "Enter donor email address"}
                    required
                    readOnly={recipientType === 'admin'}
                    className={`form-input ${recipientType === 'admin' ? 'readonly-input' : ''}`}
                  />
                  {recipientType === 'admin' && (
              ...
              <div className="form-section">
                ...
                <input
                  ...
                  placeholder={recipientType === 'admin' 
...
{messagesOpen && (
  ...
  onClick={() => {
    // First, open the new message modal
    setShowNewMessageModal(true);
    // Then, close the messages popup with a small delay
    setTimeout(() => {
      setMessagesOpen(false);
    }, 10);
  }}
>
  ...
  >
      ...
      <div className="message-sender">
        ...
        <div className="sender-info">
          ...
          <p className="message-role">
            {message.role?.includes('admin') ? 'Admin Support' : 
             message.role?.includes('donor') ? 'Food Donor' : 'System'}
          </p>
        </div>
      </div>
    ...
    <div className="message-content">
      {/* ✅ UPDATED: Show Subject as main title */}
      <h5 className="message-subject">
        {message.subject || 'No Subject'}
      </h5>
      
      {/* ✅ UPDATED: Show Message Body Preview */}
      ...
      {/* ✅ UPDATED: Show attachment indicator if present */}
