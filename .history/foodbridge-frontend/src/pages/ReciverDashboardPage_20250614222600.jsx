...
import {
  ...
  Phone, Lock, BarChart, PieChart, ArrowLeft, Receipt, Leaf, Users,  Flag, FileText, Upload, AlertTriangle, Send, X, Check, 
  Shield, ExclamationTriangle, AlertOctagon, Info
} from 'lucide-react';
...
// Open report modal for specific food item
...
const submitFoodReport = async () => {
  ...
  try {
    ...
    // Food information (copy from selected food)
    ...
    if (response.data.success) {
      ...
      showSuccessNotification(
        `Food report submitted successfully! Report ID: ${response.data.reportId}. 
      ...
      // Optionally refresh available foods
