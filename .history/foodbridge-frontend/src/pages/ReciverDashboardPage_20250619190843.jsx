...
const closeHelpCenterModal = () => {
  ...
  return (
    ...
    >
      <div
        className={`modal-container rounded-xl shadow-xl overflow-hidden w-full max-w-4xl max-h-[90vh] ${
        ...
        <div className={`flex border-b ${darkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gray-50'}`}>
          {Object.entries(tabData).map(([key, tab]) => (
            <button
              ...
              className={`flex-1 py-3 px-4 font-medium text-sm flex items-center justify-center transition-all duration-300 ${
                activeHelpTab === key
