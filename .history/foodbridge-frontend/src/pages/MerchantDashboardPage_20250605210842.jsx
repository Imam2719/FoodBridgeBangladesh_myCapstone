...
import {
  ...
  Search,
  ShoppingBag,
  Clock, Bell, X, PauseCircle, PlayCircle,
...
onst handleDeleteSale = async (saleId) => {
...
const handleDonationSubmit = async (e) => {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      case 'order':
        return <ShoppingBag size={16} className="notification-icon order" />;
      case 'system':
        return <AlertCircle size={16} className="notification-icon system" />;
      case 'message':
        return <MessageSquare size={16} className="notification-icon message" />;
      case 'promotion':
        return <Award size={16} className="notification-icon promotion" />;
      default:
...
const fetchFoodItemsWithRemaining = async () => {
  ...
  return (
    <div className="merchant-dashboard dark:bg-gray-900 dark:text-gray-100">
        ...
        <div className="dashboard-content">
          ...
          <div className="content-header">
            ...
            <div className="header-actions">
              ...
              <button className="action-btn" onClick={handleOrderHistory}>
                <History size={18} />
              ...
              <div className="stats-cards">
                <div className="stat-card">
                  ...
                  <div className="stat-content">
                    <h4>{getTotalItemsSaved()} items</h4>
      ...
      {orderHistoryOpen && (
        <div className="popup-overlay">
          <div className="popup-content order-history-popup">
            <div className="popup-header">
              <h2>Order History</h2>
              <button className="close-button" onClick={() => setOrderHistoryOpen(false)}>
                <X size={28} />
              </button>
            </div>
                  ...
                  {orders.map(order => (
                    <div key={order.id} className="order-card">
                      <div className="order-header">
                        ...
                        <div className={`order-status ${getOrderStatusColor(order.status)}`}>
                          {order.status}
                        </div>
                      </div>
                      ...
                      <div className="order-customer">
                        <div className="customer-details">
                          ...
                          <p>{order.deliveryType} • {order.deliveryAddress}</p>
                        </div>
                      </div>
                      ...
                      <div className="order-actions">
                        <button
                          className="order-action-btn contact"
      ...
      {notificationsOpen && (
        <div className="popup-overlay">
          <div className="popup-content notifications-popup">
            <div className="popup-header">
              <h2>Notifications</h2>
              <button className="close-button" onClick={() => setNotificationsOpen(false)}>
                <X size={24} />
              </button>
            </div>
            <div className="popup-body">
