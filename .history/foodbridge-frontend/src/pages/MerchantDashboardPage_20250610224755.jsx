  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-2xl max-h-[85vh] overflow-y-auto">
        ...
        <form onSubmit={handleSendNewMessage} className="p-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              {newMessageData.recipientType === 'admin' && (
                <small className="text-gray-500 text-xs">Admin email is automatically selected and cannot be changed</small>
              )}
            </div>
              ...
              {newMessageData.attachment && (
                <div className="mt-2 p-2 bg-gray-50 rounded-lg">
                  <span className="text-sm text-gray-600">
                    Selected: {newMessageData.attachment.name} ({(newMessageData.attachment.size / 1024).toFixed(1)} KB)
                  </span>
                </div>
              )}
