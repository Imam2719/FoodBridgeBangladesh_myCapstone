...
import {
  ...
  FileText, CheckCircle, Verified, X
} from 'lucide-react';
...
const SignupPage = () => {
  ...
  return (
    <div className="elegant-signup-container">
      <div className="signup-inner">
        ...
        <form onSubmit={handleSubmit} className="elegant-form">
          {/* Camera section at the top with motivational content */}
          <div className="camera-section-wrapper">
            ...
            <div className="camera-motivation-layout">
              {/* Left side motivation */}
              <div className="motivation-column">
                <div className="motivation-card donor">
                  <Heart size={24} className="motivation-icon" />
                  <h3>For Food Donors</h3>
                  <p>"Every meal you share helps someone in need. Your generosity creates ripples of hope across our community."</p>
                  <div className="motivation-stats">
                    <div className="stat">
                      <span className="stat-number">40%</span>
                      <span className="stat-label">of food is wasted</span>
                    </div>
                    <div className="stat">
                      <span className="stat-number">1</span>
                      <span className="stat-label">donation feeds 3 people</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="camera-column">
                ...
                {!showCamera && !photoTaken ? (
                  <div className="photo-placeholder" onClick={() => setShowCamera(true)}>
                    <Camera size={36} />
                    <span>Click to take your profile photo</span>
                  </div>
                ) : null}
              ...
              <div className="motivation-column">
                <div className="motivation-card receiver">
                  <User size={24} className="motivation-icon" />
                  <h3>For Food Recipients</h3>
                  <p>"Access nutritious meals with dignity. We're here to support you through difficult times and help you focus on what matters most."</p>
                  <div className="motivation-stats">
                    <div className="stat">
                      <span className="stat-number">820+</span>
                      <span className="stat-label">people helped monthly</span>
                    </div>
                    <div className="stat">
                      <span className="stat-number">100%</span>
                      <span className="stat-label">fresh, quality food</span>
                    </div>
                  </div>
                </div>
              </div>
