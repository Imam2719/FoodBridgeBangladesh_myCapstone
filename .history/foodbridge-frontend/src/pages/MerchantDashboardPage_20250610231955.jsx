      ...
      <div className="message-modal-container">
        <div className="message-modal-content">
          ...
          <div className="message-modal-header">
            <h3 className="message-modal-title">Send New Message</h3>
            <button 
              ...
              <div className="form-content">
                ...
                <div className="form-group">
                  ...
                  <div className="recipient-type-selection">
                    <label className={`recipient-type-option ${newMessageData.recipientType === 'admin' ? 'selected' : ''}`}>
                      <input
                        type="radio"
                        name="recipientType"
                        value="admin"
                    ...
                    <label className={`recipient-type-option ${newMessageData.recipientType === 'donor' ? 'selected' : ''}`}>
                      <input
                        type="radio"
                        name="recipientType"
                        value="donor"
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder={newMessageData.recipientType === 'admin' ? "Admin Email (Auto-filled)" : "donor@example.com"}
                    required
                    readOnly={newMessageData.recipientType === 'admin'}
                    className={`form-input ${newMessageData.recipientType === 'admin' ? 'readonly' : ''}`}
                  />
                  {newMessageData.recipientType === 'admin' && (
                    <small className="helper-text">Admin email is automatically selected and cannot be changed</small>
                  )}
                </div>
                ...
                <div className="form-group">
                  ...
                  <div className="file-upload-container">
                    ...
                    {newMessageData.attachment && (
                      <div className="file-selected">
                        <div className="file-info">
                          ...
                          <span className="file-size">({(newMessageData.attachment.size / 1024).toFixed(1)} KB)</span>
                        </div>
                        <button 
                          type="button" 
                    ...
                    <small className="helper-text">
                      Supported formats: PDF, DOC, DOCX, JPG, PNG, TXT, XLSX (Max 10MB)
                    </small>
                  </div>
                </div>
              </div>
