  ...
  return (
    <div className="merchant-dashboard dark:bg-gray-900 dark:text-gray-100">
      ...
      <main className="dashboard-main" style={{ paddingTop: '64px' }}>
        ...
        // ========== ENHANCED PREMIUM HEADER WITH WELCOME MESSAGE ==========
<div className="enhanced-premium-header">
  ...
  <div className="enhanced-actions-container">
    <div className="main-actions-grid">
      <button className="enhanced-action-btn fees-btn" onClick={handleFees}>
        <div className="btn-icon-wrapper">
          <Wallet size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-primary-text">Pay Fees</span>
          <span className="btn-secondary-text">Manage payments</span>
        </div>
        <div className="btn-action-indicator">
          <ArrowRight size={18} />
        </div>
      </button>

      <button className="enhanced-action-btn donations-btn" onClick={() => setDonationsOpen(true)}>
        <div className="btn-icon-wrapper">
          <Heart size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-primary-text">My Donations</span>
          <span className="btn-secondary-text">Track donations</span>
        </div>
        <div className="btn-action-indicator">
          <ArrowRight size={18} />
        </div>
      ...
      <button className="enhanced-action-btn sales-btn" onClick={handleSalesHistory}>
        <div className="btn-icon-wrapper">
          <History size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-primary-text">Sales History</span>
          <span className="btn-secondary-text">View reports</span>
        </div>
        <div className="btn-action-indicator">
          <ArrowRight size={18} />
        </div>
      ...
      <button className="enhanced-action-btn messages-btn" onClick={handleMessages}>
        <div className="btn-icon-wrapper">
          <MessageSquare size={24} />
          {messageStats.unreadMessages > 0 && (
            <div className="enhanced-notification-badge">
              {messageStats.unreadMessages > 99 ? '99+' : messageStats.unreadMessages}
            </div>
          )}
        </div>
        <div className="btn-text-content">
          <span className="btn-primary-text">Messages</span>
          <span className="btn-secondary-text">Communications</span>
        </div>
        <div className="btn-action-indicator">
          <ArrowRight size={18} />
        </div>
      ...
      <button className="enhanced-action-btn profile-btn" onClick={handleProfileUpdate}>
        <div className="btn-icon-wrapper">
          <Settings size={24} />
        </div>
        <div className="btn-text-content">
          <span className="btn-primary-text">Profile</span>
          <span className="btn-secondary-text">Account settings</span>
        </div>
        <div className="btn-action-indicator">
          <ArrowRight size={18} />
        </div>
    ...
    <div className="special-actions-row">
      <button className="special-action-btn create-btn" onClick={() => handleOpenModal()}>
        <div className="special-btn-icon">
          <Plus size={28} />
        </div>
        <div className="special-btn-content">
          <span className="special-btn-title">Add New Item</span>
          <span className="special-btn-subtitle">Create food listing</span>
        </div>
        <div className="special-btn-glow"></div>
      </button>

      <button className="special-action-btn logout-btn" onClick={handleLogout}>
        <div className="special-btn-icon">
          <LogOut size={24} />
        </div>
        <div className="special-btn-content">
          <span className="special-btn-title">Logout</span>
          <span className="special-btn-subtitle">Sign out</span>
        </div>
      </button>
    </div>
  </div>
...
{/* ========== ENHANCED PREMIUM STATISTICS OVERVIEW ========== */}
<div className={`enhanced-stats-container ${statsVisible ? 'expanded' : 'collapsed'}`}>
  ...
  {!statsVisible && (
    <div className="enhanced-collapsed-preview">
      <div className="preview-stat">
        <span className="preview-number">{overviewStats.loading ? '...' : getTotalItemsSold().toLocaleString()}</span>
...
/*
========== COMPLETE CSS FOR ENHANCED PREMIUM DASHBOARD ==========
Add this CSS to your MerchantDashboardPage.css file
*/
