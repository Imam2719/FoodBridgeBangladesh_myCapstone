...
// Food item images for background animation
const foodItems = [
  '/images/food/fruits.jpg',
  '/images/food/vegetables.jpg',
  '/images/food/bread.jpg',
  '/images/food/pasta.jpg',
  '/images/food/soup.jpg',
  '/images/food/salad.jpg',
  '/images/food/grains.jpg',
  '/images/food/meals.jpg',
];
...
const LoginPage = () => {
  ...
  // Effect for rotating food background images
  useEffect(() => {
  ...
  return (
    <div className={`auth-page ${darkMode ? 'dark-mode' : ''}`}>
      {/* Dynamic Food Background */}
      <div className="food-background">
        {foodItems.map((food, index) => (
          <div 
            key={index} 
            className={`food-slide ${index === currentFoodIndex ? 'active' : ''}`}
      ...
      <div className="login-container">
        <div className="login-brand">
          <Heart size={35} color="#e11d48" fill="#e11d48" className="pulse-icon" />
          <h2>FoodShare</h2>
        </div>
