    ...
    <div className="merchant-dashboard dark:bg-gray-900 dark:text-gray-100">
      ...
      <main className="dashboard-main" style={{ paddingTop: '64px' }}>
        <div className="dashboard-content">
         ...
         // Replace the existing content-header and stats-summary sections in MerchantDashboardPage.jsx with this premium version
...
<div className="premium-content-header">
  ...
  <div className="premium-actions-grid">
    <button className="premium-action-btn fees-btn" onClick={handleFees}>
      <div className="btn-icon-container">
        <Wallet size={20} />
        <div className="btn-glow"></div>
      </div>
      <div className="btn-content">
        <span className="btn-label">Pay Fees</span>
        <span className="btn-sublabel">Manage payments</span>
      </div>
    ...
    <button className="premium-action-btn donations-btn" onClick={() => setDonationsOpen(true)}>
      <div className="btn-icon-container">
        <Heart size={20} />
        <div className="btn-glow"></div>
      </div>
      <div className="btn-content">
        <span className="btn-label">My Donations</span>
        <span className="btn-sublabel">Track donations</span>
      </div>
      <div className="btn-arrow">
        <ArrowRight size={16} />
      </div>
    ...
    <button className="premium-action-btn sales-btn" onClick={handleSalesHistory}>
      <div className="btn-icon-container">
        <History size={20} />
        <div className="btn-glow"></div>
      </div>
      <div className="btn-content">
        <span className="btn-label">Sales History</span>
        <span className="btn-sublabel">View reports</span>
      </div>
      <div className="btn-arrow">
        <ArrowRight size={16} />
      </div>
    ...
    <button className="premium-action-btn messages-btn" onClick={handleMessages}>
      <div className="btn-icon-container">
      ...
      <div className="btn-content">
        ...
        <span className="btn-sublabel">Communications</span>
      </div>
      <div className="btn-arrow">
        <ArrowRight size={16} />
      </div>
    ...
    <button className="premium-action-btn profile-btn" onClick={handleProfileUpdate}>
      <div className="btn-icon-container">
        <Settings size={20} />
        <div className="btn-glow"></div>
      </div>
      <div className="btn-content">
        ...
        <span className="btn-sublabel">Account settings</span>
      </div>
      <div className="btn-arrow">
        <ArrowRight size={16} />
      </div>
    ...
    <button className="premium-action-btn create-btn" onClick={() => handleOpenModal()}>
      <div className="btn-icon-container">
        <Plus size={20} />
        <div className="btn-glow"></div>
      </div>
      <div className="btn-content">
        <span className="btn-label">Create Listing</span>
        <span className="btn-sublabel">Add new item</span>
      </div>
      <div className="btn-arrow">
        <ArrowRight size={16} />
      </div>
    ...
    <button className="premium-action-btn logout-btn" onClick={handleLogout}>
      <div className="btn-icon-container">
        <LogOut size={20} />
        <div className="btn-glow"></div>
      </div>
      <div className="btn-content">
        ...
        <span className="btn-sublabel">Sign out</span>
      </div>
      <div className="btn-arrow">
        <ArrowRight size={16} />
      </div>
...
{/* ========== PREMIUM STATISTICS OVERVIEW SECTION ========== */}
<div className={`premium-stats-container ${statsVisible ? 'expanded' : 'collapsed'}`}>
  <div className="premium-stats-header">
    ...
    <button className="premium-toggle-btn" onClick={toggleStats}>
  ...
  {statsVisible && (
    <div className="premium-stats-grid">
      {/* Items Sold Card */}
      <div className="premium-stat-card items-sold-card">
      ...
      <div className="premium-stat-card active-listings-card">
        <div className="stat-card-header">
          <div className="stat-icon-container">
            <Tag size={28} />
            <div className="icon-bg-glow"></div>
      ...
      {/* Total Revenue Card */}
      <div className="premium-stat-card revenue-card">
        <div className="stat-card-header">
          <div className="stat-icon-container">
            <DollarSign size={28} />
            <div className="icon-bg-glow"></div>
  ...
  {!statsVisible && (
    <div className="collapsed-stats-preview">
