...
const handleFees = async () => {
  ...
  try {
    ...
    if (!feeData.success && feeData.message) {
      ...
      setFeeData({
  ...feeData,
  paymentHistory: Array.isArray(feeData.paymentHistory) ? feeData.paymentHistory : []
});
    }
...
setFeeData(prev => ({ ...prev, paymentHistory: historyArray }));
    }
  } catch (error) {
...
const handlePaymentSubmit = async (e) => {
  ...
  try {
    ...
    if (response.ok && result.success) {
      ...
      const currentPaymentHistory = Array.isArray(feeData.paymentHistory) ? feeData.paymentHistory : [];
// Then use:
paymentHistory: [result.paymentRecord, ...currentPaymentHistory] 
      });
