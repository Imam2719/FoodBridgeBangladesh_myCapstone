  ...
  try {
    ...
    if (response.ok && result.success) {
      ...
      setFeeData({
        ...
        paymentHistory: [result.paymentRecord, ...(Array.isArray(feeData.paymentHistory) ? feeData.paymentHistory : [])]
      });
          ...
          {feesLoading ? (
            ...
            <>
              ...
              <div className="payment-history enhanced-history dark:bg-gray-800 dark:border dark:border-gray-700">
                ...
                {!Array.isArray(feeData.paymentHistory) || feeData.paymentHistory.length === 0 ? (
