  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Modal Footer */}
        <div className="modal-footer p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-750 flex justify-between items-center sticky bottom-0 z-10">
          <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center">
            <Bookmark className="h-4 w-4 mr-2 text-purple-500" />
            <span>Total Saved Items: {savedDonationsData.length}</span>
          </div>
          <button
            onClick={closeSavedDonationsModal}
            className="px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition flex items-center space-x-2"
          >
